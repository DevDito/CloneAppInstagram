package com.satriaamrudito.cloneappinstagram.adapter
...
import com.satriaamrudito.cloneappinstagram.fragments.ProfileFragment
import com.satriaamrudito.cloneappinstagram.model.User
...
class UserAdapter(private var mContext: Context, private val mUser: List<User>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserAdpterViewHolder {
        ...
        val view = LayoutInflater.from(mContext).inflate(R.layout.list_search, parent, false)
